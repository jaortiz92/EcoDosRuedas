...
INSERT INTO clientes VALUES ('neon', 'Nelson', 'Ruiz', 'neon@hotmail.com', '3123219876', 454326545, '1994-10-20');
...
FOREIGN KEY (alias_fk) REFERENCES clientes(alias),
...
SELECT * FROM intencion_de_compra;
